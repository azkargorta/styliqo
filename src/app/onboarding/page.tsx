      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <ol className="space-y-4 text-sm leading-7 text-stone-700">
            ...
            <li>3. Crea 2 conjuntos base: oficina y diario.</li>
            <li>4. Planifica un evento de esta semana para empezar a usar el planificador.</li>
            <li>5. Si activas premium, genera tus primeros conjuntos con el asistente personal.</li>
          </ol>
        </SectionCard>
      </div>
    </main>
